  ...
  routes: [
	...
	// 前台页面路由
    {
      ...
      children: [
        ...
        { path: 'vedio', name: 'vedio', component: () => import('../views/front/Vedio.vue') },
        { path: 'feedback', name: 'feedback', component: () => import('../views/front/Feedback.vue') },
        { path: 'collect', name: 'collect', component: () => import('../views/front/Collect.vue') },
        { path: 'follow', name: 'follow', component: () => import('../views/front/Follow.vue') },
          { path: 'notice-detail', name: 'notice-detail', component: () => import('../views/front/NoticeDetail.vue') },
          { path: 'vedio-detail', name: 'vedio-detail', component: () => import('../views/front/VedioDetail.vue') },
      ]
    }
  ]
})
