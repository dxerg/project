...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="您确定删除吗？" @confirm="confirmDelBatch" v-if="auths.includes('banner.deleteBatch')">
        <template #reference>
    ...
    <div style="margin: 10px 0">
      ...
      <el-table-column prop="indexRadio" label="是否首页"></el-table-column>

        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('banner.edit')">修改<el-icon style="vertical-align: middle"><Edit /></el-icon></el-button>
            <el-popconfirm title="您确定删除吗？" @confirm="del(scope.row.id)" v-if="auths.includes('banner.delete')">
              <template #reference>
    ...
    <el-dialog v-model="dialogFormVisible" title="轮播图信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        <el-form-item label-width="100" prop="img" label="图片">
        ...
        <el-form-item label-width="100" prop="url" label="链接地址">
          <el-input v-model="state.form.url" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label-width="100" prop="indexRadio" label="是否首页">
          <el-radio-group v-model="state.form.indexRadio">
