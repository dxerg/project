<script setup>
  ...
  const load = () => {
    ...
    request.get('/front/feedback/page', {
      params: {
        name: name,
  ...
  <div>
    ...
    <div style="width:85%;margin: 0 auto;margin-bottom: 50px;">
        <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;">
          <span style="font-size: 14px;margin-right: 20px;">当前位置：首页 > 用户反馈</span>
        </div>

        <div style="padding-bottom: 15px ;border-bottom: 3px solid #333333; text-align: left;display: flex;">
          <span style="font-weight: bold; font-size: 24px;float: left;flex: 3;color: #333333;">用户反馈</span>

          <div style="margin-top: 10px;float: right;flex: 1;">
            <el-input style="width: 200px" placeholder="查询用户反馈" v-model="state.searchKey" clearable></el-input>
